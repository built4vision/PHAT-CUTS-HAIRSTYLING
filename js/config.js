/* ==========================================================================
   PHAT CUTS HAIRSTYLING × BUILT4VISION — "Where the Culture Gets Fresh"
   ...
   ========================================================================== */
const CONFIG = {
  businessName: "Phat Cuts Hairstyling",
  songTitle: "Where the Culture Gets Fresh",
  ...
  address: "Downtown Wilmington, Delaware",
  ...
  paymentLinks: {
    package: {
      stripe: "https://buy.stripe.com/bJeaEX3zJ6cv0Xf9y24sE03",
    },
    song: {
      stripe: "https://buy.stripe.com/7sY8wP9Y7cAT7lDh0u4sE02",
    },
  },
